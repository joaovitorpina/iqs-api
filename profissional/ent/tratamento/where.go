...
func ID(id int) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}

// IDEQ applies the EQ predicate on the ID field.
func IDEQ(id int) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func IDLT(id int) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func Descricao(v string) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func DescricaoEQ(v string) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldDescricao), v))
	})
}
...
func DescricaoNEQ(v string) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func DescricaoIn(vs ...string) predicate.Tratamento {
...
func DescricaoNotIn(vs ...string) predicate.Tratamento {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DescricaoGT(v string) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func DescricaoGTE(v string) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func DescricaoLT(v string) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func DescricaoLTE(v string) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func DescricaoContains(v string) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func DescricaoHasPrefix(v string) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func DescricaoHasSuffix(v string) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func DescricaoEqualFold(v string) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func DescricaoContainsFold(v string) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func HasProfissional() predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
...
func HasProfissionalWith(preds ...predicate.Profissional) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func And(predicates ...predicate.Tratamento) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Or(predicates ...predicate.Tratamento) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Not(p predicate.Tratamento) predicate.Tratamento {
	return predicate.Tratamento(func(s *sql.Selector) {
		p(s.Not())
	})
}
