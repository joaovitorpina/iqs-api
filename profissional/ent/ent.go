...
func columnChecker(table string) func(string) error {
	checks := map[string]func(string) bool{
		areasaude.Table:      areasaude.ValidColumn,
		convenio.Table:       convenio.ValidColumn,
		especializacao.Table: especializacao.ValidColumn,
		foto.Table:           foto.ValidColumn,
		podcast.Table:        podcast.ValidColumn,
		profissional.Table:   profissional.ValidColumn,
		tratamento.Table:     tratamento.ValidColumn,
